...
function changeNum() {
	...
	var cks = document.getElementsByName("cks");
	var m=cks.length;
	var v=document.getElementById("ck").value;
	for(var i = 0; i < trs.length; i++) {
		...
		td.onclick = function() {
           ...
           /* var fir=trs[i].getElementsByTagName("td")[0];
            var s=fir.nextElementSibling.value;*/
			...
			inp.onblur = function() {
				...
				//window.location.href="/BookStore/cart/change?count="+n+"&ck="+m+"&bid="+v;
			}
